    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            if (!$order || !is_object($order)) {
                $this->logger->error('OrderUpdate: Invalid order object.');
                return;
            }
            ...
            $this->webhookHelper->sendWebhook('update_order', $webhookData);

        } catch (\Exception $e) {
            $this->logger->error('OrderUpdate Observer Error: ' . $e->getMessage(), [
